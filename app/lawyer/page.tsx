...
export const metadata: Metadata = {
  title: 'AI Chatbot + Online Booking for Law Firms — smartflowdev',
  description:
    'Custom-built AI chatbot for law firms. Answers client questions 24/7, schedules consultations, captures leads. Live in 5 days.',
};
        ...
        <section className={s.hero}>
          <div className={`container ${s.heroInner}`}>
            ...
            <h1 className={`display ${s.heroTitle}`}>
              ...
              <span className="gradient-text">native</span> to your law firm.
            </h1>

            <p className={s.heroSub}>
              Custom-built, brand-matched AI chatbot + online consultation booking — built
            ...
            <div className={s.twoCards}>
              <ScrollReveal delay={0}>
                <div className={`${s.serviceCard} ${s.serviceCardIndigo}`}>
                  ...
                  <p className={s.serviceDesc}>
                    Trained on your firm&rsquo;s data — practice areas, consultation process,
                    fees, FAQs. Answers client questions 24/7 and flags urgent cases.
                  </p>
              ...
              <ScrollReveal delay={150}>
                <div className={`${s.serviceCard} ${s.serviceCardAmber}`}>
                  ...
                  <p className={s.serviceDesc}>
                    Clients book consultations in 3 clicks. Synced to your Google Calendar
                    instantly. Email confirmations included.
                  </p>
                  <ul className={s.serviceChecks}>
                    <li><span className={`${s.checkIcon} ${s.checkIconAmber}`}>{checkSvg}</span> Google Calendar sync</li>
                    <li><span className={`${s.checkIcon} ${s.checkIconAmber}`}>{checkSvg}</span> Email consultation confirmations</li>
                    <li><span className={`${s.checkIcon} ${s.checkIconAmber}`}>{checkSvg}</span> Works on mobile</li>
                  </ul>
                </div>
              </ScrollReveal>
            </div>
          ...
          <div className={`container ${s.splitRow}`}>
            <div className={s.splitLeft55}>
              ...
              <p className={s.splitSub}>
                Not a generic widget slapped on. We match your colors, typography,
                tone — so it feels native. Clients don&rsquo;t even notice it&rsquo;s a
                chatbot at first.
              </p>
              ...
              <div className={s.featureGrid}>
                {[
                  ...
                  ['Trained on you', 'Practice areas, fees, FAQs'],
                  ['24/7 on', 'Even at 2 AM'],
                  ['Lead capture', 'Every message to reception'],
                  ['Case triage', 'Flags urgent inquiries'],
              ...
              <div className={s.chatMockup}>
                ...
                <div className={s.chatMessages}>
                  <div className={`${s.chatBubble} ${s.chatBubbleBot}`}>
                    Hi! 👋 How can I help today? I can schedule a consultation, answer questions about our practice areas, or connect you to an attorney.
                  </div>
                  <div className={`${s.chatBubble} ${s.chatBubbleUser}`}>
                    I need help with a personal injury case.
                  </div>
                  <div className={`${s.chatBubble} ${s.chatBubbleBot}`}>
                    I can help with that. Would you like to schedule a free consultation with one of our injury attorneys? 📅
                  </div>
                </div>
        ...
        <ScrollReveal as="section" className={s.bookingSection}>
          <div className={`container ${s.splitRow} ${s.splitRowReverse}`}>
            ...
            <div className={s.splitRight55}>
              ...
              <p className={s.splitSub}>
                Clients pick a date, a time, a consultation type. Appointment lands in your
                Google Calendar in seconds. No phone tag, no hold music.
              </p>

              <div className={s.featureGrid}>
                {[
                  ['Calendar sync', 'Instant Google Calendar entry'],
                  ['Email confirmations', 'Sent to client instantly'],
                  ['Mobile-first', 'Most clients book from phone'],
                  ['Self-service', 'Reschedule without calling'],
                  ['Auto-confirm', 'Email to client instantly'],
          ...
          <div className="container">
            <div className={s.sectionHeader}>
              ...
              <h2 className={`display ${s.statsSectionTitle}`}>
                Clients in 2026 don&rsquo;t{' '}
                <span className={s.roseText}>wait.</span>
              </h2>
              <p className={s.statsSubtitle}>
                This is how people actually choose and hire legal representation now.
              </p>
            </div>
            ...
            <div className={s.statsGrid}>
              {[
                ...
                { value: '3\u00D7', color: 'amber', text: 'more consultations with chatbot + booking' },
            ...
            <p className={s.statsSource}>
              Sources: Clio Legal Trends Report 2025, FindLaw Consumer Survey
            </p>
          </div>
        </ScrollReveal>
                ...
                <div className={s.priceCardFeaturedWrap}>
                  ...
                  <div className={`${s.priceCard} ${s.priceCardFeatured}`}>
                    ...
                    <ul className={s.planFeatures}>
                      ...
                      <li><span className={s.checkIcon}>{checkSvg}</span> Email consultation reminders</li>
